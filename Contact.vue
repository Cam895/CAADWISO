...
<div class="myBlocks">
  ...
  <form @submit.prevent="handleSubmit()">
    <h2>Mail</h2>
    <div>
      <label for="lastname"><small>* </small>Nom</label>
    ...
    <div>
      <label for="firstname"><small>* </small>Prénom</label>
    ...
    <div>
      ...
      <input class="field" id="phone" type="tel" pattern="[0-7]{2}-[0-9]{2}-[0-9]{2}-[0-9]{2}-[0-9]{2}" v-model.trim="phone"/>
    </div>
    <div>
      <label for="mail"><small>* </small>Email</label>
